...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 01 Février 2016 à 18:08
...
CREATE TABLE `files` (
  ...
  `thumbs` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `files` (`id`, `title`, `user_id`, `file_type`, `file_size`, `url_file`, `nb_like`, `category`, `keywords`, `description`, `licence`, `licence_filter`, `content_type`, `thumbs`, `created`) VALUES
...
--
-- Contenu de la table `likes-files`
--

INSERT INTO `likes-files` (`id`, `user_id`, `file_id`) VALUES
(1, 4, 7),
(2, 4, 10),
(3, 2, 3),
(4, 2, 4),
...
(1, 'phil', 'philippe.agm@gmail.com', 'phil', '2080-01-22', 'France', '', 'Et interdum acciderat, ut siquid in penetrali secreto nullo citerioris vitae ministro praesente paterfamilias uxori susurrasset in aurem, velut \r\n\r\nAmphiarao referente aut Marcio, quondam vatibus inclitis, postridie disceret imperator. ideoque etiam parietes arcanorum soli conscii timebantur.', 0, '2016-01-22 00:00:00', '', '2016-02-01 10:25:16'),
(2, 'user1', 'user1@gmail.com', 'user1', '2070-01-22', 'France', '', 'Et interdum acciderat, ut siquid in penetrali secreto nullo citerioris vitae ministro praesente paterfamilias uxori susurrasset in aurem, velut \r\n\r\nAmphiarao referente aut Marcio, quondam vatibus inclitis, postridie disceret imperator. ideoque etiam parietes arcanorum soli conscii timebantur.', 0, '2016-01-21 00:00:00', '', '2016-02-01 10:25:24'),
(3, 'user2', 'user2.agm@gmail.com', 'user2', '2090-01-22', 'France', '', 'Et interdum acciderat, ut siquid in penetrali secreto nullo citerioris vitae ministro praesente paterfamilias uxori susurrasset in aurem, velut \r\n\r\nAmphiarao referente aut Marcio, quondam vatibus inclitis, postridie disceret imperator. ideoque etiam parietes arcanorum soli conscii timebantur.', 0, '2016-01-20 00:00:00', '', '2016-02-01 10:25:29'),
(4, 'phil@gmail.com', 'phil@gmail.com', '$2y$10$CIRA3fkX34sKLzeIjdy68O0P3iqeuenNgCvvgSWp1lrO/CM1Rr/hW', '2016-01-28', '', '', '', 1, '2016-01-28 13:02:18', '$2y$10$fiuMYbn2DXgfnuvl54rwWeKT3u9pNAgQBiN3HhucFoETpEjeGgQ1m', '2016-02-01 14:46:27');
