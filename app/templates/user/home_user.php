...
<section id="tri_Section" class="clearfix">
	...
	<!--Barre principal de tri pour smartphone et tablette-->
		...
		<nav id="tri_Desktop">
			<h4>Tri par :</h4>
			<ul>
				<li><a id="tri_All" class="selected select-type" data-type="vm" href="#" title="Voir tout les contenus">Tout</a></li>
				<li><a id="tri_Music" class="select-type" data-type="musique" href="#" title="Voir seulement la musique">Musique</a></li>
	...
	<div id="tri_Second">
		<nav>
			<ul>
				...
				<li><a id="tri_Mine" class="select-mode" data-column="created+user_id" data-order="DESC"href="#" title="Voir mes contenus">Upload</a></li>
			</ul>
		</nav>
	</div>
</section>
...
<section id="latest_Content" class="wrap home_Content clearfix">
	...
	<section id="tri_Complet">
		...
		<nav>
			<h5>Video</h5>
			<ul>
				<li><a class="select-category" data-type="animation" href="#" title="animation">Animation</a></li>
