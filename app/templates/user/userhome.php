		...
		<div id="tri_Second">
			<nav>
				<ul>
					...
					<li><a id="tri_New" class="selected_2 select-mode" data-column="created" data-order="DESC" href="#tri" title="Voir les nouveaux contenus">Nouveautés</a></li>
					<li><a id="tri_Pop" class="select-mode" data-column="nb_like" data-column="created" data-order="DESC" href="#tri" title="Voir les plus populaires">Popularité</a></li>
					<li><a id="tri_Like" class="select-mode" data-column="like_me" data-order="DESC" href="#tri" title="Voir mes contenus préférés">J'aime</a></li>
					<li><a id="tri_Mine" class="select-mode" data-column="upload&user" data-order="DESC" href="#tri" title="Voir mes contenus">Upload</a></li>
				</ul>
			</nav>
		</div>
	</section>
	...
	<section id="latest_Content" class="wrap home_Content clearfix">
		...
		<section id="tri_Complet">
			...
			<nav>
				<h5>Musique</h5>
				<ul>
					<li><a class="select-category" data-category="pop" data-type="musique" href="#tri" title="pop">Pop</a></li>
