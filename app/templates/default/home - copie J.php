...
=======
					<a href="#logger"><input id="connect_Button" name="connection" type="submit" value="Se connecter"></a>
>>>>>>> jerem
...
=======
					<a href="#logger"><input id="inscription_Button" name="inscription" type="submit" value="S'inscrire"></a>
>>>>>>> jerem
				</div>
...
=======
					<input type="checkbox" value="remember_me" name="remember" id="remember_User">
>>>>>>> jerem
...
=======
				<input id="recover_Mdp" class="hide" type="email" name="password_Recovery" placeholder="Tapez votre email">
>>>>>>> jerem
				<!--<div class="errorLogger">
					<h6>Le champs email n'est pas au bon format !</h6>
				</div>-->
...
=======
			...
			<figure class="clearfix">
				...
				<figcaption>
						...
						<div class="info_Bottom">
							<a href="Profil.html" title="Voir le profil de ..."><img class="user_Min" src="i<?=$this->assetUrl('img_site/user.png')?>"></a>
