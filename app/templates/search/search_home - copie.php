...
<!-- Affichage de ce qui a été recherché ainsi que le nombre d'éléments trouvés -->
	<section id="search-result" class="clearfix">
	...
	<!--Pour une vidéo-->
		<figure class="clearfix">
			<video id="mavideo" class="clearfix" controls>
			    ...
			    <p class="alert">otre navigateur ne supporte pas la balise vidéo ! Mettez-le à jour !</p>
			</video>
		...
		<figure class="clearfix">
			...
			<figcaption class="clearfix">
					<div class="info_Top clearfix">
						<h3><a href="content.html" title="Voir la vidéo"><strong>Audio title</strong></a></h3>
						<span class="social_Nav">
							<a id="none" class="follow" href="" title="Suivre l'auteur"><button>Suivre</button></a>
							<a id="none" class="like" href="" title="Aimer le contenu"><img src="img_site/like.png" alt="j'aime"></a>
						</span>
